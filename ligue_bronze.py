    ...
    for drone in Drone.my_drones_list:
        ...
        #     output = f'WAIT '
            ...
            if drone.creatureFollowed == -1 :
                ...
                unseen_creatures = [creature for creature in drone.radarListeDetails if creature[1] not in Drone.waitingScanList and creature[1] not in Drone.commonScanList  and creature[1] not in Creature.creatureFollowed]
